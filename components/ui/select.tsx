...
/**
 * Size lives in cva so the height stays a plain utility. It used to be a
 * data-attribute variant, and tailwind-merge only dedupes classes within the
 * same variant group — so a caller's `h-12` survived next to the component's
 * own height instead of replacing it, and the prefixed rule won on cascade
 * order. Every select in the app was pinned to 32px no matter what it asked
 * for. Plain utilities let tailwind-merge resolve the conflict properly.
 */
